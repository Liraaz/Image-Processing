...
class Student:
        ...
        #2nd button 
                ...
                take_photo_btn=Button(btn_frame1,command=self.generate_datasets,text="Take Photo Sample",width=40,font=("times new roman",12,"bold"),bg="blue",fg="white")
               ...
               messagebox.showerror("Error","All Fields are required",parent=self.root)
                ...
                try:
                        ...
                        if Upadate>0:
                                conn=mysql.connector.connect(host="localhost",username="root",password="Himadri@124",database="face_recognizer")
                                my_cursor=conn.cursor()
                                my_cursor.execute("update student set Dep=%s,Year=%s,Semester=%s,Roll=%s,Dob=%s,Gender=%s,Email=%s,Phone=%s,Address=%s,PhotoSample=%s where Student_id=%s",(
