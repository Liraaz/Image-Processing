...
#department
        ...
        dep_combo=ttk.Combobox(current_course_frame,font=("times new roman",12,"bold"),state="readonly",width=30)
...
#Year
        ...
        year_combo=ttk.Combobox(current_course_frame,font=("times new roman",12,"bold"),state="readonly",width=30)
...
#roll no
        ...
        Roll_entry=ttk.Entry(class_student_frame,width=25,font=("times new roman",12,"bold"))
...
#gender
        ...
        gender_entry=ttk.Entry(class_student_frame,width=25,font=("times new roman",12,"bold"))
        gender_entry.grid(row=1,column=1,padx=10,pady=10,sticky=W)
 ...
 #DOB
        ...
        dob_entry=ttk.Entry(class_student_frame,width=25,font=("times new roman",12,"bold"))
...
#email
        ...
        email_entry=ttk.Entry(class_student_frame,width=25,font=("times new roman",12,"bold"))
...
#phone no
        ...
        Phone_no_entry=ttk.Entry(class_student_frame,width=25,font=("times new roman",12,"bold"))
        Phone_no_entry.grid(row=2,column=3,padx=10,pady=10,sticky=W)

#address
        address_label=Label(class_student_frame,text="Address:",font=("times new roman",12,"bold"),bg="white")
        address_label.grid(row=3,column=0,padx=10,sticky=W)

        address_entry=ttk.Entry(class_student_frame,width=25,font=("times new roman",12,"bold"))
...
#teacher name 
        ...
        teacher_name_entry=ttk.Entry(class_student_frame,width=25,font=("times new roman",12,"bold"))
        teacher_name_entry.grid(row=3,column=3,padx=10,pady=10,sticky=W)

 #radio Buttons
        radiobtn1=ttk.Radiobutton(class_student_frame,text="Take a Photo Sample",value="Yes & No")
...
#========table frame=====
        ...
        self.student_table=ttk.Treeview(table_frame,column=("dep","course","year","sem","name","roll","gender","dob","email","phone","address","teacher","photo"),xscrollcommand=scroll_x.set,yscrollcommand=scroll_y.set)
